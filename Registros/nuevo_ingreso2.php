...
$ini = 0 ;
  $tipo_m = $tipo_m;
	...
	$serial=uniqid();
  $sql_insert = "INSERT INTO reporte (tipo_m, compu_tipo, compu_unidades, compu_fecha, compu_cli, compu_des, compu_observacion) VALUES ( '$tipo_m', '$tipo', '$unidades', '$fecha', '$compu_cli', '$obser', '$descripcion')";

  $sql_insert2 = "INSERT INTO registro (tipo, descripcion, obser, unidades, fecha, serial) VALUES ( '$tipo', '$descripcion', '$obser', '$unidades', '$fecha', '$serial')";
