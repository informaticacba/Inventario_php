...
// declarando las variables provenientes desde tipo.php
...
//$ini = 0 ;
	$nombre_tipo = ucwords($nombre_tipo);//Primera Letra de cada palabra en Mayusculas
	//$detalle = strtoupper($detalle[$ini]);
	
$sql_insert = "INSERT INTO configuracion (nombre_tipo) VALUES ( '$nombre_tipo')";
