...
<br><br><br><br><br><br>
<center>
  <form method="post" action="tipo_upd.php" name="formulario" id="formulario" autocomplete="off">
  <fieldset>
    <legend>Ingreso De Nuevo Tipo</legend>
  
<!--   //descripcion articulo-->
<br>
<input type="text" name="nombre_tipo" size="30" maxlength="10" autofocus placeholder="Ingrese..." required />
